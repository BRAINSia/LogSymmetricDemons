#ifndef __itkBCHConjugateActionFilter_h
#define __itkBCHConjugateActionFilter_h
...
/** \class BCHConjugateActionFilter
...
class ITK_EXPORT BCHConjugateActionFilter :
  public InPlaceImageFilter<TInputImage, TOutputImage>
{
public:
  /** Standard class typedefs. */
  typedef BCHConjugateActionFilter             Self;
  ...
  itkTypeMacro( BCHConjugateActionFilter, InPlaceImageFilter );
...
#endif
private:
  BCHConjugateActionFilter(const Self &); // purposely not implemented
...
#include "itkBCHConjugateActionFilter.hxx"
#endif
